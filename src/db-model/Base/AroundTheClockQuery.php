...
/**
 * Base class that represents a query for the 'aroundTheClock' table.
 *
 *
 *
 * @method     ChildAroundTheClockQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 * @method     ChildAroundTheClockQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildAroundTheClockQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildAroundTheClockQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildAroundTheClockQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildAroundTheClockQuery leftJoinPlayer($relationAlias = null) Adds a LEFT JOIN clause to the query using the Player relation
 * @method     ChildAroundTheClockQuery rightJoinPlayer($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Player relation
 * @method     ChildAroundTheClockQuery innerJoinPlayer($relationAlias = null) Adds a INNER JOIN clause to the query using the Player relation
 *
 * @method     ChildAroundTheClockQuery joinWithPlayer($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Player relation
 *
 * @method     ChildAroundTheClockQuery leftJoinWithPlayer() Adds a LEFT JOIN clause and with to the query using the Player relation
 * @method     ChildAroundTheClockQuery rightJoinWithPlayer() Adds a RIGHT JOIN clause and with to the query using the Player relation
 * @method     ChildAroundTheClockQuery innerJoinWithPlayer() Adds a INNER JOIN clause and with to the query using the Player relation
 *
 * @method     \PlayerQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildAroundTheClock findOne(ConnectionInterface $con = null) Return the first ChildAroundTheClock matching the query
 * @method     ChildAroundTheClock findOneOrCreate(ConnectionInterface $con = null) Return the first ChildAroundTheClock matching the query, or a new ChildAroundTheClock object populated from the query conditions when no match is found
 *
 ...
 *
 * @method     ChildAroundTheClock requireOneById(int $id) Return the first ChildAroundTheClock filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 */
abstract class AroundTheClockQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\AroundTheClockQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AroundTheClock', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildAroundTheClockQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildAroundTheClockQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildAroundTheClockQuery) {
            return $criteria;
        }
        $query = new ChildAroundTheClockQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildAroundTheClock|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(AroundTheClockTableMap::DATABASE_NAME);
        }
        ...
        if ((null !== ($obj = AroundTheClockTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildAroundTheClock A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildAroundTheClock $obj */
            $obj = new ChildAroundTheClock();
            $obj->hydrate($row);
            AroundTheClockTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $id, $comparison);
    }

    /**
     * Filter the query on the bullIncluded column
     *
     * Example usage:
     * <code>
     * $query->filterByBullincluded(true); // WHERE bullIncluded = true
     * $query->filterByBullincluded('yes'); // WHERE bullIncluded = true
     * </code>
     *
     * @param     boolean|string $bullincluded The value to use as filter.
     ...
     * @return $this|ChildAroundTheClockQuery The current query, for fluid interface
     */
    public function filterByBullincluded($bullincluded = null, $comparison = null)
    {
        if (is_string($bullincluded)) {
            $bullincluded = in_array(strtolower($bullincluded), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(AroundTheClockTableMap::COL_BULLINCLUDED, $bullincluded, $comparison);
    }

    /**
     * Filter the query on the dartsNeeded column
     *
     * Example usage:
     * <code>
     * $query->filterByDartsneeded(1234); // WHERE dartsNeeded = 1234
     * $query->filterByDartsneeded(array(12, 34)); // WHERE dartsNeeded IN (12, 34)
     * $query->filterByDartsneeded(array('min' => 12)); // WHERE dartsNeeded > 12
     * </code>
     *
     * @param     mixed $dartsneeded The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildAroundTheClockQuery The current query, for fluid interface
     */
    public function filterByDartsneeded($dartsneeded = null, $comparison = null)
    {
        if (is_array($dartsneeded)) {
            $useMinMax = false;
            if (isset($dartsneeded['min'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_DARTSNEEDED, $dartsneeded['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dartsneeded['max'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_DARTSNEEDED, $dartsneeded['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AroundTheClockTableMap::COL_DARTSNEEDED, $dartsneeded, $comparison);
    }
    ...
    public function filterByPlayerid($playerid = null, $comparison = null)
    {
        if (is_array($playerid)) {
            ...
            if (isset($playerid['min'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_PLAYERID, $playerid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($playerid['max'])) {
                $this->addUsingAlias(AroundTheClockTableMap::COL_PLAYERID, $playerid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildAroundTheClockQuery The current query, for fluid interface
     */
    public function filterByPlayer($player, $comparison = null)
    {
        if ($player instanceof \Player) {
            return $this
                ->addUsingAlias(AroundTheClockTableMap::COL_PLAYERID, $player->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AroundTheClockTableMap::COL_PLAYERID, $player->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildAroundTheClock $aroundTheClock Object to remove from the list of results
     *
     * @return $this|ChildAroundTheClockQuery The current query, for fluid interface
     */
    public function prune($aroundTheClock = null)
    {
        if ($aroundTheClock) {
            $this->addUsingAlias(AroundTheClockTableMap::COL_ID, $aroundTheClock->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the aroundTheClock table.
     *
    ...
    {
        if (null === $con) {
            $con = Propel::getServiceContainer()->getWriteConnection(AroundTheClockTableMap::DATABASE_NAME);
        }
        ...
        return $con->transaction(function () use ($con) {
            ...
            AroundTheClockTableMap::clearInstancePool();
            AroundTheClockTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(AroundTheClockTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            AroundTheClockTableMap::removeInstanceFromPool($criteria);
