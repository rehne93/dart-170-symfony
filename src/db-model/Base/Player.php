...
abstract class Player implements ActiveRecordInterface
{
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[PlayerTableMap::COL_PASSWORD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PlayerTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PlayerTableMap::COL_PASSWORD)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlayerTableMap::COL_PASSWORD)) {
            $criteria->add(PlayerTableMap::COL_PASSWORD, $this->password);
        }
